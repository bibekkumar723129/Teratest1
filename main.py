...
𝐏𝐋𝐀𝐍'𝐒 : /plans"""
    ...
    channel1 = "@AdultsVideoLink"
    channel2 = "@AdultsVideoLink"  # Replace with the actual username of your second channel
...
async def handle_message(m: Message):
    # Define the channels
    channel1 = "@AdultsVideoLink"
    channel2 = "@AdultsVideoLink" # Replace with your second channel
